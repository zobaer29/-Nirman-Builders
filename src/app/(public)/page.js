...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-emerald-600 to-cyan-600 py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to Start Your Project?</h2>
          <p className="text-emerald-50 text-lg mb-8">Get a free consultation and quote for your dream project today</p>
          <Link href="#contact">
            <button className="bg-white text-emerald-600 hover:bg-gray-100 font-bold px-10 py-4 rounded-xl shadow-lg transition-all duration-300 hover:scale-105">
